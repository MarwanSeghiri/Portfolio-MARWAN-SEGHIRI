...
ScrollReveal().reveal('.home-img, .services-content, .languages-scroll, .portfolio-box, .contact form', { origin: 'bottom' });
...
const typed = new Typed('.multiple', {
    strings: ['Développeur Web', 'Développeur Front-End', 'Développeur Back-End', 'UI/UX Designer'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
